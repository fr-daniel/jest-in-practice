...
describe("# MAP", () => {
  ...
  it("map(1) should thorow a TypeError with message 'The first parameter must be an array'", () => {
    let error;
  ...
  it("map([1, 2], 'function') should thorow a TypeError with message 'The second parameter must be a function'", () => {
    let error;
